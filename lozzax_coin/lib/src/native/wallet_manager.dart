...
import 'package:lozzax_coin/src/exceptions/wallet_creation_exception.dart';
import 'package:lozzax_coin/src/exceptions/wallet_restore_from_keys_exception.dart';
import 'package:lozzax_coin/src/exceptions/wallet_restore_from_seed_exception.dart';

final createWalletNative = lozzaxApi
    .lookup<NativeFunction<create_wallet>>('create_wallet')
    .asFunction<CreateWallet>();

final restoreWalletFromSeedNative = lozzaxApi
    .lookup<NativeFunction<restore_wallet_from_seed>>(
        'restore_wallet_from_seed')
    .asFunction<RestoreWalletFromSeed>();

final restoreWalletFromKeysNative = lozzaxApi
    .lookup<NativeFunction<restore_wallet_from_keys>>(
        'restore_wallet_from_keys')
    .asFunction<RestoreWalletFromKeys>();

final isWalletExistNative = lozzaxApi
    .lookup<NativeFunction<is_wallet_exist>>('is_wallet_exist')
    .asFunction<IsWalletExist>();

final loadWalletNative = lozzaxApi
