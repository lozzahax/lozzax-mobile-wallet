...
import 'package:lozzax_wallet/src/stores/send/sending_state.dart';
...
import 'package:lozzax_wallet/src/wallet/lozzax/calculate_estimated_fee.dart';
import 'package:lozzax_wallet/src/widgets/address_text_field.dart';
import 'package:lozzax_wallet/src/widgets/lozzax_dialog.dart';
import 'package:lozzax_wallet/src/widgets/scollable_with_bottom_section.dart';
...
class SendFormState extends State<SendForm> {
  ...
  Future<void> getOpenAliasRecord(BuildContext context) async {
    ...
    if (isOpenAlias) {
      ...
      await showSimpleLozzaxDialog(context, S.of(context).openalias_alert_title,
                    ...
                    children: <Widget>[
                        ...
                        return Column(
                            ...
                            children: <Widget>[
                              Text(S.of(context).send_your_wallet,
                                  style: TextStyle(
                                      fontSize: 12, color: LozzaxPalette.teal)),
                      ...
                      Observer(builder: (context) {
                        ...
                        return Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: <Widget>[
                              Text(S.current.lozzax_available_balance,
                                  style: TextStyle(
                                    fontSize: 12,
                                    color: Theme.of(context)
                                        .accentTextTheme
                ...
                child: Container(
                  ...
                  child: Column(children: <Widget>[
                    AddressTextField(
                      ...
                      placeholder: S.of(context).send_lozzax_address,
                      ...
                      validator: (value) {
                        sendStore.validateAddress(value,
                            cryptoCurrency: CryptoCurrency.lozzax);
                      ...
                      child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              errorBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: LozzaxPalette.red, width: 1.0)),
                              focusedErrorBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: LozzaxPalette.red, width: 1.0)),
                              errorStyle: TextStyle(color: LozzaxPalette.red)),
                          validator: (value) {
                            sendStore.validateLOZAXX(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                              '${calculateEstimatedFee(priority: settingsStore.transactionPriority)} LZX',
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
                                color: Theme.of(context)
    ...
    reaction((_) => sendStore.state, (SendingState state) {
      if (state is SendingFailed) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          showSimpleLozzaxDialog(context, S.of(context).error, state.error,
              onPressed: (_) => Navigator.of(context).pop());
        });
      }
