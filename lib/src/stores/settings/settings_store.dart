...
abstract class SettingsStoreBase with Store {
  SettingsStoreBase(
      ...
      @required LozzaxTransactionPriority initialTransactionPriority,
  ...
  static Future<SettingsStore> load(
    ...
    final currentTransactionPriority = LozzaxTransactionPriority.deserialize(
  ...
  @observable
  LozzaxTransactionPriority transactionPriority;
  ...
  Future setCurrentTransactionPriority(
      {@required LozzaxTransactionPriority priority}) async {
