...
import 'package:lozzax_wallet/src/domain/common/calculate_fiat_amount.dart';
...
import 'package:lozzax_wallet/src/start_updating_price.dart';
...
abstract class BalanceStoreBase with Store {
  ...
  String get fullBalanceString {
    if (fullBalance == null) {
      return lozzaxAmountToString(0, detail: _settingsStore.balanceDetail);
    }

    return lozzaxAmountToString(fullBalance, detail: _settingsStore.balanceDetail);
  }
  ...
  String get unlockedBalanceString {
    ...
    return lozzaxAmountToString(unlockedBalance, detail: _settingsStore.balanceDetail);
  }
...
//  }
  ...
  Future _onBalanceChange(Balance balance) async {
    final _balance = balance as LozzaxBalance;
