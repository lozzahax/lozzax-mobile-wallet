...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m6(item, app_store) => "NEVER input your Lozzax wallet ${item} into any software or website other than the OFFICIAL Lozzax wallets downloaded directly from the ${app_store}, the Lozzax website, or the Lozzax GitHub.\nAre you sure you want to access your wallet ${item}?";

  static m7(state_error) => "Failed authentication. ${state_error}";

  static m8(item) => "NEVER give your Lozzax wallet ${item} to ANYONE!";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "error_text_lozzax" : MessageLookupByLibrary.simpleMessage("LOZAXX value can\'t exceed available balance.\nThe number of fraction digits must be less or equal to 12"),
    ...
    "openalias_alert_title" : MessageLookupByLibrary.simpleMessage("LOZAXX Recipient Detected"),
    "outgoing" : MessageLookupByLibrary.simpleMessage("Outgoing"),
    "lozzax_available_balance" : MessageLookupByLibrary.simpleMessage("LOZAXX Available Balance"),
    "lozzax_full_balance" : MessageLookupByLibrary.simpleMessage("LOZAXX Full Balance"),
    "lozzax_hidden" : MessageLookupByLibrary.simpleMessage("LOZAXX Hidden"),
    ...
    "restore_description_from_backup" : MessageLookupByLibrary.simpleMessage("You can restore the whole Lozzax Wallet app from your back-up file"),
    ...
    "send_lozzax" : MessageLookupByLibrary.simpleMessage("Send LOZAXX"),
    "send_lozzax_address" : MessageLookupByLibrary.simpleMessage("Lozzax address"),
    "send_priority" : m11,
    "send_title" : MessageLookupByLibrary.simpleMessage("Send Lozzax"),
