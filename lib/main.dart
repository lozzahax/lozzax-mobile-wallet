...
import 'package:lozzax_wallet/router.dart' as lozzaxroute;
import 'theme_changer.dart';
import 'themes.dart';
import 'package:lozzax_wallet/src/domain/common/get_encryption_key.dart';
...
import 'package:lozzax_wallet/src/reactions/set_reactions.dart';
import 'package:lozzax_wallet/src/stores/login/login_store.dart';
...
import 'package:lozzax_wallet/src/screens/root/root.dart';
...
import 'package:lozzax_wallet/src/domain/common/default_settings_migration.dart';
...
void main() async {
  try {
    ...
    final settingsStore = await SettingsStoreBase.load(
        ...
        initialTransactionPriority: LozzaxTransactionPriority.blink,
...
Future<void> initialSetup(
    ...
    WalletType initialWalletType = WalletType.lozzax}) async {
  ...
  lozzax_wallet.onStartup();
}

class LozzaxWalletApp extends StatelessWidget {
  LozzaxWalletApp() {
...
class MaterialAppWithTheme extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        onGenerateRoute: (settings) => lozzaxroute.Router.generateRoute(
            sharedPreferences: sharedPreferences,
            walletListService: walletListService,
            walletService: walletService,
